...
#
# Generated by export_simulation on Fri Nov 07 10:28:49 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './cpu_inst3_rom.sh' script.

./cpu_inst3_rom.sh -reset_run
...
./cpu_inst3_rom.sh -noclean_files

For more information on the script, please type './cpu_inst3_rom.sh -help'.
